...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(LatLongException.class)
	public ResponseEntity<MyErrorDetails> latLongExceptionHandler(LatLongException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> pincodeExceptionHandler(PincodeException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> billExceptionHandler(BillException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> categoryExceptionHandler(CategoryException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> foodCartExceptionHandler(FoodCartException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> itemExceptionHandler(ItemException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> orderDetailsExceptionHandler(OrderDetailsException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> RestaurantExceptionHandler(RestaurantException me, WebRequest re) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(me.getMessage());
		err.setDescription(re.getDescription(false));
