...
public class HelpDesk {
    ...
    static HelpDeskToHospitalInterface helpDeskToHospitalInterface = new Hospital();
    static PatientFunctionInterface patientFunctionInterface = new Hospital();
    static HospitalHelpDeskInterface hospitalHelpDeskInterface = new Hospital();
    public  void callHelpDesk(){
     ...
     static void newRegistrationDetails() {
        ...
        String patientId = hospitalHelpDeskInterface.patientRegistration(patientName, patientGender, patientAge, patientNumber, 1 );
