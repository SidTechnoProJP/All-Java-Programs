...
public class OrderController {
    ...
    public ResponseEntity<List<MyOrders>> myOrders(){
        return ResponseEntity.of(Optional.of(orderInterface.viewOrders()));
    }

    @GetMapping("/my-ordered-items")
    public ResponseEntity<List<MyOrderItems>> myOrderedItem(@RequestPart String orderId){
        return ResponseEntity.of(Optional.of(orderInterface.viewItemsOfOrder(orderId)));
    }
